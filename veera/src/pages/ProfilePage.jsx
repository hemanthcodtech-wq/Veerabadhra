...
export function ProfilePage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col pb-20">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 mt-8">
          ...
          <Link to="/login" className="bg-brand-green text-white font-bold px-8 py-3 rounded-xl text-sm">Login</Link>
          <Link to="/signup" className="text-brand-green text-sm font-semibold">Create Account</Link>
        </div>
        <BottomNav />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <Header title="My Profile" />
      <div className="bg-brand-green text-white px-6 pt-6 pb-8 rounded-b-[2.5rem] shadow-sm">
