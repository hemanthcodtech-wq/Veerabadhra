      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex flex-wrap items-end gap-4">
          ...
          <button onClick={handleSaveShipping} disabled={savingShipping}
            className="flex items-center gap-2 bg-white text-brand-green px-5 py-2.5 rounded-xl font-bold hover:bg-white transition-all disabled:opacity-50">
        ...
        <div className="flex gap-3 mb-6">
          {['flat', 'pincode'].map(mode => (
            <button key={mode} onClick={() => setTaxMode(mode)}
              className={`px-4 py-2 rounded-xl font-semibold text-sm border transition-all ${taxMode === mode ? 'bg-white text-brand-green border-brand-dark-blue' : 'bg-gray-50 text-gray-600 border-gray-200 hover:border-gray-300'}`}>
          ...
          <div className="space-y-5">
            ...
            <form onSubmit={handleAddPincode} className="flex flex-col sm:flex-row gap-3">
              ...
              <button type="submit" disabled={savingPincode}
                className="flex items-center justify-center gap-2 bg-white text-brand-green px-5 py-2 rounded-xl font-bold hover:bg-white transition-all disabled:opacity-50 whitespace-nowrap">
