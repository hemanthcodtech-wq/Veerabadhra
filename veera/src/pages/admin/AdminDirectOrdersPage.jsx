...
const updateStatus = async (orderId, status) => {
  ...
  const notifyWhatsApp = (order) => {
    ...
    const msg = encodeURIComponent(
      ...
      (order.status === 'ready for pickup'
        ? `Your order is ready for pickup at *10-34 Malkapur X road, Sangareddy-502001*. Please come pick it up at your convenience! 🏪`
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-2xl border border-brand-green/10 p-10 text-center">
                  ...
                  <div className="border-t border-brand-green/5 p-3 sm:p-4 lg:p-5 space-y-4">
                    ...
                    <div>
                      ...
                      <select value={order.status} onChange={e => updateStatus(order.id, e.target.value)}
                        className="w-full sm:w-64 px-3 py-2 rounded-xl bg-[#FDF7E5] border border-brand-green/10 text-gray-900 font-sans text-sm focus:outline-none">
                    ...
                    {/* Actions */}
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-brand-green/5">
