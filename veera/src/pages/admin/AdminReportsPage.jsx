  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-2xl border border-brand-green/10 p-5 shadow-sm">
          ...
          <button onClick={() => downloadReport('revenue')} className="w-full mt-2 flex items-center justify-center gap-2 bg-[#FDF7E5] text-gray-900 py-2 rounded-xl text-sm font-semibold hover:bg-brand-green text-white/10 transition-colors">
        ...
        <div className="bg-white rounded-2xl border border-brand-green/10 p-5 shadow-sm">
          ...
          <button onClick={() => downloadReport('orders')} className="w-full mt-2 flex items-center justify-center gap-2 bg-[#FDF7E5] text-gray-900 py-2 rounded-xl text-sm font-semibold hover:bg-brand-green text-white/10 transition-colors">
      ...
      <div className="bg-white rounded-2xl border border-brand-green/10 p-5 shadow-sm">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl bg-[#FDF7E5] border border-brand-green/5">
              <div>
                <p className="font-sans font-bold text-gray-900">{report.title}</p>
                <p className="text-xs text-gray-900/50">{report.desc}</p>
              </div>
              <button onClick={() => downloadReport(report.type)} className="flex items-center justify-center gap-2 bg-white border border-brand-green/20 text-gray-900 px-4 py-2 rounded-lg text-sm font-semibold hover:bg-brand-green text-white hover:text-white transition-colors">
