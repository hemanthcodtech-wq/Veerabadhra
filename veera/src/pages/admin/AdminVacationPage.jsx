        ...
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            className={`w-full flex items-center justify-between p-4 rounded-xl border-2 transition-all ${
              vacation.is_active
                ...
                : 'border-brand-green/10 bg-brand-green text-white/5'
            }`}
          >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-[#FDF7E5] border border-brand-green/20 focus:outline-none focus:border-[#D4AF37] text-gray-900 text-sm resize-none"
            />
