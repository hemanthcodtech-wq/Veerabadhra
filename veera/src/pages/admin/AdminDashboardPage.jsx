...
export function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-6 sm:mb-8">
        {stats.map((s, i) => (
          <motion.div key={s.label} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.08 }}
            className="bg-white rounded-xl sm:rounded-2xl border border-brand-green/10 p-3 sm:p-4 flex flex-col gap-2 sm:gap-3">
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl border border-brand-green/10 p-3 sm:p-6">
          ...
          <div className="overflow-x-auto -mx-3 sm:mx-0">
            <div className="inline-block min-w-full align-middle px-3 sm:px-0">
              <table className="w-full text-sm font-sans min-w-[480px]">
                <thead>
                  <tr className="text-gray-900/50 text-[10px] sm:text-xs uppercase tracking-wider border-b border-brand-green/5">
                ...
                <tbody className="divide-y divide-[#08183A]/5">
                  {orders.slice(0, 8).map((order) => (
                    <tr key={order.id} className="hover:bg-[#FDF7E5]/30 transition-colors">
