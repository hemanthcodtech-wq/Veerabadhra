    ...
    <div className="w-full max-w-5xl mx-auto">
      ...
      <div className="relative mb-6">
        ...
        <input value={search} onChange={(e) => setSearch(e.target.value)}
          ...
          className="w-full pl-9 pr-4 py-3 rounded-xl bg-white border border-brand-green/10 text-gray-900 font-sans text-sm focus:outline-none focus:border-brand-green/30 shadow-sm" />
      </div>
      ...
      <div className="bg-white rounded-2xl border border-brand-green/10 overflow-hidden shadow-sm">
        <div className="overflow-x-auto">
          <table className="w-full text-sm font-sans min-w-[680px]">
            <thead>
              <tr className="bg-[#FDF7E5] text-gray-900/60 text-xs uppercase tracking-wider border-b border-brand-green/10">
            ...
            <tbody className="divide-y divide-[#08183A]/5">
              {filtered.map((customer, i) => (
                <motion.tr key={customer.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: i * 0.02 }} className="hover:bg-[#FDF7E5]/50 transition-colors">

                  {/* Name */}
                  <td className="py-4 px-4 sm:px-6">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-brand-green text-white/10 flex items-center justify-center text-gray-900 font-bold shrink-0">
