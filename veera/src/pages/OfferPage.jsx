...
export function OfferPage() {
  ...
  if (!activeOffer) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#FDF7E5] text-gray-900">
        ...
        <button onClick={() => navigate('/')} className="bg-brand-green text-white px-8 py-3 rounded-xl font-bold hover:bg-brand-orange text-white transition-colors">
          Return to Home
        </button>
      </div>
    );
  ...
  return (
    <div className="bg-[#FDF7E5] min-h-screen pb-20">
      <Header title={`Offer: ${activeOffer.title}`} showShare={true} />
      
      {/* Offer Banner */}
      <div className="w-full bg-brand-green text-white relative overflow-hidden">
        {/* Decorative elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-6">
        <div className="flex items-center justify-between mb-6 border-b border-brand-green/10 pb-4">
        ...
        {offerProducts.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-sm border border-brand-green/10 mb-4">
