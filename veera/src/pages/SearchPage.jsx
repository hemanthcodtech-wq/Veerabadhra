      ...
      <div className="max-w-3xl mx-auto px-4 pt-12 pb-6">
        ...
        {!trimmed && (
          <div>
            {recentSearches.length > 0 && (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-[10px] font-bold text-brand-green uppercase tracking-[0.22em]">Recent Searches</h3>
                  <button onClick={clearRecent} className="text-xs text-brand-green font-bold hover:underline">Clear</button>
                </div>
            ...
            <div>
              <h3 className="text-[10px] font-bold text-brand-green uppercase tracking-[0.22em] mb-3">Browse Categories</h3>
              <div className="flex flex-wrap gap-2">
                {categories.map(cat => (
        ...
        {trimmed && catSuggestions.length > 0 && (
          <div className="mb-5">
            <h3 className="text-[10px] font-bold text-brand-green uppercase tracking-[0.22em] mb-3">Categories</h3>
            <div className="flex flex-wrap gap-2">
        ...
        <div>
          <div className="flex items-center justify-between mb-3 mt-6">
            <h3 className="text-[10px] font-bold text-brand-green uppercase tracking-[0.22em]">
