    ...
    <div className="min-h-screen bg-gray-50 pb-20 font-sans flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 md:p-8 mt-8 max-w-2xl mx-auto w-full">
        ...
        >
          ...
          <CheckCircle2 className="w-28 h-28 text-[#073020] relative z-10 drop-shadow-md" strokeWidth={1.5} />
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm md:text-base">Thank you for shopping with VEERABADHRA ENTERPRISE. Your order is being prepared and will be with you shortly!</p>
        </motion.div>
          ...
          <div className="relative z-10 space-y-6">
            <div className="flex items-center justify-between border-b border-gray-100 pb-5">
              ...
              <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold ${
                order?.order_type === 'pickup' ? 'bg-[#FDF7E5] text-[#073020] border border-[#FFC107]/30' : 'bg-red-50 text-[#073020] border border-red-100'
              }`}>
            ...
            {order?.order_type === 'pickup' && (
              <div className="bg-[#FDF7E5] border border-[#FFC107]/30 rounded-2xl p-4 space-y-3">
                <div className="flex items-start gap-3">
                  <MessageCircle className="w-5 h-5 text-[#073020] shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-start gap-3 border-t border-[#FFC107]/20 pt-3">
                  <MapPin className="w-5 h-5 text-[#073020] shrink-0 mt-0.5" />
                  <div>
                    ...
                    <a
                      ...
                      className="text-xs text-[#073020] font-bold underline mt-1 inline-block hover:text-[#b81633]"
                    >
                      View on Google Maps →
                    </a>
                  </div>
