...
<table style="width:100%;margin-top:16px;border-collapse:collapse;">
  ...
  <tr style="background:#FDF7E5;"><td style="text-align:right;padding:10px 12px;font-weight:700;font-size:11pt;border-top:2px solid #08183A;">TOTAL</td><td style="text-align:right;padding:10px 12px;font-weight:700;font-size:11pt;color:#D4AF37;border-top:2px solid #08183A;">₹${Number(order.total).toFixed(2)}</td></tr>
</table>
<div style="margin-top:24px;text-align:center;font-size:9pt;color:#999;">Thank you for shopping with VEERABADHRA ENTERPRISE!</div>
</body></html>`;
  };
      ...
      <div className="max-w-lg mx-auto px-4 pt-4 pb-8">
            ...
            <button
              ...
              className={`shrink-0 px-5 py-2 rounded-full text-sm font-bold transition-all ${
                activeFilter === f.key
                  ...
                  : 'bg-white text-gray-500 border border-gray-200 hover:border-brand-green/30'
              }`}
            >
              {f.label}
            </button>
        ...
        {filteredOrders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 gap-4 bg-white rounded-3xl border border-gray-100 shadow-sm">
            ...
            {activeFilter === 'all' && (
              <Link to="/" className="mt-2 bg-brand-green text-white text-sm font-bold px-8 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5">
                Start Shopping
              </Link>
            )}
          </div>
                  ...
                  <div className="px-4 pt-4 pb-3">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-sm font-bold text-brand-green flex items-center gap-1 hover:opacity-80 transition-opacity"
                      >
                    ...
                    <div className="border-t border-gray-100">
                        ...
                        <div className="px-4 py-4 bg-gray-50 border-b border-gray-100">
                          <div className="flex items-center justify-between mb-3 relative">
                            ...
                            {STATUS_STEPS.map((_, i) => i < STATUS_STEPS.length - 1 && (
                              <div key={`line-${i}`} className={`absolute h-0.5 top-4 ${i < stepIdx ? 'bg-brand-green' : 'bg-gray-200'}`}
                            ...
                            {STATUS_STEPS.map((step, i) => (
                              <div key={step} className="flex flex-col items-center flex-1 z-10">
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-all ${
                                  i < stepIdx ? 'bg-brand-green border-brand-green text-white' : i === stepIdx ? 'bg-brand-green border-brand-green text-white shadow-lg shadow-brand-green/30' : 'bg-white border-gray-200 text-gray-300'
                                }`}>
                                  {i < stepIdx ? '✓' : i + 1}
                                </div>
                              </div>
                      ...
                      <div className="px-4 py-3 space-y-1.5 border-b border-gray-100">
                        ...
                        <div className="flex justify-between text-sm font-bold text-gray-900 pt-2 border-t border-gray-100">
                          ...
                          <span className="text-brand-green">₹{Number(order.total).toLocaleString('en-IN')}</span>
                        </div>
                      </div>
                      ...
                      <div className="px-4 py-3 flex gap-3">
                        ...
                        <button onClick={() => handleReorder(order)}
                          className="flex-1 flex items-center justify-center gap-2 bg-brand-green text-white rounded-xl py-2.5 text-sm font-bold hover:opacity-90 transition-opacity">
