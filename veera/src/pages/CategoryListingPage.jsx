...
import fallbackBannerImg from '../assets/story_temple.png';
          ...
          <>
            <button
              ...
              className={`min-h-[38px] shrink-0 rounded-full border px-5 py-1.5 text-sm font-semibold transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-gold motion-reduce:transition-none ${
                !modelQuery
                  ? 'border-[#073020] bg-[#073020] text-white'
          ...
          <>
            ...
            >
              <div className={`w-[60px] h-[60px] rounded-full flex items-center justify-center border-2 overflow-hidden transition-all ${
                categoryId === 'all' ? 'border-[#073020] bg-red-50' : 'border-transparent bg-white shadow-sm group-hover:border-gray-200'
              }`}>
                <LayoutGrid className={`w-6 h-6 ${categoryId === 'all' ? 'text-[#073020]' : 'text-gray-400'}`} />
              </div>
              <span className={`text-[10px] font-semibold text-center w-[72px] leading-tight ${categoryId === 'all' ? 'text-[#073020]' : 'text-gray-600'}`}>
                All Categories
              </span>
            </button>
            {categories.map((category) => (
              ...
              >
                <div className={`w-[60px] h-[60px] rounded-full flex items-center justify-center border-2 overflow-hidden bg-white transition-all ${
                  categoryId === String(category.id) ? 'border-[#073020] p-[2px]' : 'border-transparent shadow-sm group-hover:border-gray-200'
                }`}>
                  <img 
                ...
                <span className={`text-[10px] font-semibold text-center w-[72px] leading-tight line-clamp-2 ${categoryId === String(category.id) ? 'text-[#073020]' : 'text-gray-600'}`}>
                  {category.name}
                </span>
              </button>
            ))}
    ...
    <div className="flex flex-col gap-7">
      <section aria-labelledby="category-filter-heading">
        <h3
          ...
          className="mb-3 text-[10px] font-bold uppercase tracking-[0.22em] text-brand-green"
        >
          Categories
        </h3>
        ...
        <section className="border-t border-brand-gold/25 pt-6" aria-labelledby="model-filter-heading">
          <div className="mb-3 flex items-center justify-between gap-3">
            <h3
              ...
              className="text-[10px] font-bold uppercase tracking-[0.22em] text-brand-green"
            >
              Subcategories
            </h3>
            {modelQuery && (
              <button
                type="button"
                onClick={() => onModelChange('')}
                className="text-xs font-semibold text-brand-green underline-offset-2 hover:underline focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand-gold"
              >
                Clear
              </button>
            )}
      ...
      <div className="md:hidden fixed inset-x-0 bottom-0 z-40 bg-white shadow-[0_-4px_10px_rgba(0,0,0,0.05)] border-t border-gray-100 rounded-t-[20px]">
        <div className="flex items-center justify-around h-[68px] px-2">
          <button
            ...
            className="flex flex-col items-center justify-center w-full gap-1 text-gray-500 hover:text-brand-green transition-colors"
          >
          ...
          <button
            onClick={() => setShowMobileFilters(true)}
            className="flex flex-col items-center justify-center w-full gap-1 text-gray-500 hover:text-brand-green transition-colors border-x border-gray-100"
          >
        ...
        <div className="fixed inset-0 z-[80] lg:hidden" aria-label="Filter overlay">
          ...
          >
            <div className="flex items-center justify-between border-b border-brand-gold/25 px-5 py-4">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-brand-green">SHOP SMART</p>
