...
import allProductsBanner from '../assets/story_temple.png';
import imgMeditation from '../assets/story_meditation.png';
import imgAarti from '../assets/story_aarti.png';
import poojaOffersBanner from '../assets/pooja_offers_banner.jpg';
  ...
  return (
    <div className="animate-section md:px-8 mb-4 md:mb-10">
      {/* <div
        ...
        style={{
          background: 'linear-gradient(135deg, #073020 0%, #B81633 60%, #073020 100%)',
    ...
    <div ref={container} className="bg-brand-beige flex-grow w-full flex flex-col pb-8">
      ...
      <div className="md:hidden bg-brand-beige pt-[140px] pb-12 px-4">
        ...
        {banners.length > 0 ? (
                ...
                <div key={banner.id} className="relative w-full h-full shrink-0">
                  ...
                  <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-6 z-10" style={{ width: '65%' }}>
                    ...
                    {banner.link_url != null && (
                      <Link to={banner.link_url || '/category/all'} className="bg-[#D4AF37] text-white text-[10px] font-extrabold px-5 py-2 rounded-lg w-fit shadow-md">
                        Shop Now
                      </Link>
                    )}
                  </div>
          ...
          <div className="relative w-full h-[180px] rounded-[20px] overflow-hidden shadow-xl">
            <img src={allProductsBanner} alt="Premium Pooja Essentials" className="absolute inset-0 w-full h-full object-cover object-center" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#073020]/90 via-[#073020]/60 to-transparent" />
            <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-6 z-10" style={{ width: '65%' }}>
              <h2 className="text-white text-xl font-serif font-bold leading-tight mb-1.5 drop-shadow-md">
                Premium Pooja<br />Essentials
              </h2>
              <p className="text-[#D4AF37] text-[11px] font-semibold mb-3 opacity-90 tracking-wide">Delivered Daily</p>
              <Link to="/category/all" className="bg-[#D4AF37] text-white text-[10px] font-extrabold px-5 py-2 rounded-lg w-fit shadow-md hover:bg-white hover:text-[#073020] transition-colors">
                Shop Now
              </Link>
            </div>
          </div>
      ...
      <div className="md:max-w-full mx-auto w-full pb-20 bg-white md:bg-transparent rounded-t-3xl md:rounded-none -mt-8 md:mt-0 relative z-10 pt-6 md:pt-0">
        ...
        <div className="hidden md:block animate-section py-8">
                ...
                <div key={banner.id} className="relative w-full h-full shrink-0">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent flex flex-col justify-center px-6 md:px-16">
                    ...
                    {(banner.link_url || banner.link_url === '') && (
                      <Link to={banner.link_url || "/category/all"} className="bg-white text-brand-green text-xs md:text-base font-bold px-8 py-3 md:py-4 rounded-xl w-fit shadow-xl hover:shadow-2xl hover:-translate-y-0.5 transition-all">
                        SHOP NOW
                      </Link>
                    )}
                  </div>
          ...
          <div className="flex justify-center px-4 md:px-24 pt-2 md:pt-6 pb-2">
            <div className="relative w-full h-72 md:h-[360px] rounded-[24px] overflow-hidden shadow-2xl border border-[#073020]/10 bg-[#FDF7E5] group">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[#FDF7E5] via-[#FDF7E5]/95 to-transparent pointer-events-none"
                style={{ width: '65%' }} />

              {/* Text content — left side */}
              <div className="absolute inset-y-0 left-0 flex flex-col justify-center px-8 md:px-12 z-10"
                style={{ width: '55%' }}>
                <h2 className="text-[#073020] text-2xl md:text-4xl lg:text-[40px] font-bold mb-3 md:mb-4 leading-[1.2] font-serif tracking-wide">
                  Premium Quality,<br />
                  <span className="text-[#D4AF37] font-semibold">Delivered Daily</span>
                </h2>
                <p className="text-gray-600 text-xs md:text-sm lg:text-[15px] mb-6 md:mb-8 max-w-[280px] md:max-w-sm leading-relaxed">
                  Shop the finest selection of premium pooja essentials, idols, and aromatic incense.
                </p>
                <Link to="/category/all" className="bg-[#073020] text-white text-[11px] md:text-xs font-bold px-6 py-3 md:px-8 md:py-3.5 rounded-xl w-fit shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all hover:bg-[#041f15] tracking-wider uppercase">
                  SHOP NOW
                </Link>
              </div>
            </div>
            ...
            {categories.map((cat) => {
              ...
              return (
                <Link key={cat.id} to={`/category/${cat.id}`} className="group flex flex-col items-center gap-2">
                  <div className="w-[72px] h-[72px] md:w-32 md:h-32 rounded-full overflow-hidden shadow-sm hover:shadow-md hover:shadow-brand-orange/20 bg-white border-2 border-brand-green/20 group-hover:border-brand-orange p-1 flex-shrink-0 transition-all duration-300 group-hover:scale-105">
        ...
        <div className="animate-section px-4 md:px-24 mb-12 flex justify-center mt-8">
          <div className="relative w-full h-56 md:h-[320px] rounded-[24px] overflow-hidden shadow-2xl shadow-brand-green/10 border border-brand-green/20 group">
            <div className="absolute inset-0 z-0">
              <img src={poojaOffersBanner} alt="Special Discounts" className="w-full h-full object-cover object-center transition-transform duration-[2000ms] group-hover:scale-105 opacity-90" />
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center px-6 md:px-12 pointer-events-none">
              ...
              <Link to="/category/all" className="bg-brand-green text-white text-xs md:text-sm font-bold px-6 py-3 md:px-8 md:py-3.5 rounded-xl w-fit hover:bg-brand-orange hover:-translate-y-1 shadow-xl shadow-brand-green/30 transition-all pointer-events-auto flex items-center gap-2">
                Explore Deals
            ...
            <div className="overflow-hidden w-full">
              ...
              >
                ...
                {[...reviews, ...reviews].map((rev, idx) => (
                  <div key={idx} className="w-[260px] md:w-[300px] p-6 shrink-0 bg-white border border-brand-green/10 rounded-[20px] shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between h-[200px]">
                    <div>
