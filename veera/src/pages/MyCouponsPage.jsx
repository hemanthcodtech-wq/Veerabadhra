    ...
    <div className="min-h-screen bg-brand-beige pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 mt-24">
        ...
        {loading ? (
          ...
          <div className="bg-white/50 backdrop-blur-sm rounded-3xl p-12 text-center border border-brand-green/10 shadow-sm">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
              <Ticket className="w-10 h-10 text-brand-green/40" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {coupons.map((coupon, idx) => (
              <motion.div 
                ...
                key={coupon.id} 
                className="bg-white rounded-2xl border border-brand-green/10 p-6 shadow-sm relative overflow-hidden flex flex-col justify-between group hover:shadow-md transition-shadow"
              >
                ...
                <div>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {coupon.user_id && (
                      <span className="bg-brand-green text-white/20 text-gray-900 text-[10px] font-bold px-2 py-1 rounded-md uppercase tracking-wider">
                        Personal
                      </span>
                    )}
                  </div>
                ...
                <button 
                  ...
                  className={`w-full py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 ${
                    copiedCode === coupon.code 
                      ...
                      : 'bg-white text-brand-green hover:bg-white shadow-lg shadow-brand-dark-blue/20'
                  }`}
                >
                  {copiedCode === coupon.code ? (
